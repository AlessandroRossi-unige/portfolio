  ...
  return (
    <div className="mx-80 my-5 border-2 border-white">
      <div className="flex flex-col p-10 px-18 gap-3">
        ...
        <p>
          After working for a few months at
        ...
        <p>
          ...
          Alongside the business logic we also
          worked on mantaining the multiple
          Databases of our client, these were{" "}
          <strong>Oracle</strong> and{" "}
        ...
        <p>
          ...
          <strong>fullstack Salesforce </strong>{" "}
          Developer working for Deloitte Italia.
        </p>
        <p>
          At Deloitte I started working on the TIM
          Sparkle Project while also learning and
          preparing for my Salesforce
          certifications. I mostly worked on the{" "}
          <strong>backend</strong> features of the
          project, using <strong>Apex</strong> (a
          javalike language), I implement new
          features, worked with the database,
          talked with the customers and{" "}
          <strong>tested</strong> the{" "}
          <strong>new features</strong> to be
          implemented. I also did{" "}
          <strong>frontend</strong> work on the
          salesforce frontend framework.
        </p>
        <p>
          In this project I worked with a medium
          size team (around 25 people) where I
          experienced both{" "}
          <strong>Waterfall</strong> development
          and <strong>Agile</strong> development.
          Me and a collegue created the
          administrative section of our customer
          portal, where the admins create, edit
          and manage new users and their
          permission, to set these permission we
          connected to an{" "}
          <strong>external API</strong> service
          called C-IAM. While in Deloitte I worked
          on my University <strong>Thesis</strong>
          , my thesis was based around studying
          every form of{" "}
          <strong>Software Testing</strong> and
          seeing what we could apply to our
          Salesforce project. We ended up
          improving our{" "}
          <strong>unit tests</strong> and I
          implemented the first{" "}
          <strong>performance tests</strong> of
          our project.
        </p>
        <p>
          For more information on my work at
          Deloitte please contact me.
        </p>
      </div>
    </div>
  );
